...
program
    ...
    .option('-r, --reporters [reporters]', 'Specify the reporters to use for this run.', util.cast.csvParse)
    ...
    .option('--api-key-alias <alias>', 'Specify the alias of the API Key to fetch remote resources using it')
    ...
    .option('--env-var <value>',
        ...
        util.cast.memoizeKeyVal)
    .option('--color <value>', 'Enable/Disable colored output. (auto|on|off)', util.cast.colorOptions)
